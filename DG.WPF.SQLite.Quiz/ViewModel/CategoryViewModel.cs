...
namespace DG.WPF.SQLite.Quiz.ViewModel
{
    ...
    {
        private static readonly string CategoryPreHtml = new ViewModelLocator().ParameterViewModel.PreHtml;
        private static readonly string CategoryPostHtml = new ViewModelLocator().ParameterViewModel.PostHtml;
